...
3. **Learn from mistakes**:
	...
	- Add to AGENTS.md or context files if the lesson would have saved significant time/effort or improved the outcome had you known it at session start
	- Keep it brief: one line per lesson is fine
